...
function scene59Answer(answer){ 
  if (answer != 'Knockout' && answer != 'convince' && answer != 'interrogate' && answer != 'Enter' && answer != 'Flee' && answer != 'Chapter 2' && answer != 'Escort' && answer != 'Captured'){ 
    $('#message').html('Please enter one of the given options.'); 
      return; 
  }
  if (answer != 'Flee' && answer != 'Escort' && answer != 'Chapter 2' && answer != 'Captured'){
    if (answer == 'Knockout'){ 
      scene63(); 
    } 
    if (answer == 'convince'){ 
...
function scene60Answer(answer){ 
  if (answer == ''){ 
    ...
    $('#question').html('Try clearing the answer bar instead');
  } 
} 
function scene61(){ 
  currentScene = 61; 
...
function scene61Answer(answer){ 
  if (answer == ''){ 
    ...
    $('#question').html('Try Pressing "Enter" instead');
  }  
} 
function scene62(){ 
  currentScene = 62; 
...
function scene64Answer(answer){ 
  if (answer != 'AA' && answer != 'Run' &&  answer != 'Knockout' && answer != 'punish' && answer != 'Enter' && answer != 'Flee' && answer != 'Chapter 2' && answer != 'Escort' && answer != 'Captured'){ 
    $('#message').html('Please enter one of the given options.'); 
    return; 
  } 
  if (answer != 'Flee' && answer != 'Chapter 2' && answer != 'Escort' && answer != 'Captured'){
