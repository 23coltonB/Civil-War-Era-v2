...
function scene82Answer(options){
  switch (options){
    case 'Level Select':
      levelSelect300();
      break;
...
function scene83Answer(options){
  switch (options){
    case 'Yes':
      scene82();
      break;
...
function scene84Answer(options){
  switch (options){
    case '"Whos the Dutchess Dragon?"':
      scene85();
      break;
    case '"What did I do?"':
      scene86();
...
function scene85Answer(options){
  switch (options){
    case 'Go with':
      scene87();
      break;
...
function scene86Answer(options){
  switch (options){
    case 'Go with':
      scene87();
      break;
...
function scene87(){
  ...
  if (x <= player.charisma){
    ...
    $('#scenetext').html('"Give me a minute" You say, overwhelmed. You take a deep breath. "Ok," you say, unsure. "Just let me change into something more... presentable, ok?" they nod, and you gingerly shut the door. This is way to much! You think to yourself frantically.');
  }
  scene87Question();
  $('#question').html('What do you do? Get Ready, Escape');
}

function scene87Answer(options){
  switch (options){
    case 'Get ready':
      scene88();
      break;
...
function scene88Answer(options){
  switch (options){
    case 'Level Select':
      levelSelect300();
      break;
